...
HD_PWD='F:/Programming/University/05_Computer Aided Digital System Design/CAD_Project/Vivado/project_CAD/project_CAD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplierTB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplierTB.tcl

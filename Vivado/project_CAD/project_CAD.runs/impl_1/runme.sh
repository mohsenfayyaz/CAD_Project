...
HD_PWD='F:/Programming/University/05_Computer Aided Digital System Design/CAD_Project/Vivado/project_CAD/project_CAD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplierTB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplierTB.tcl -notrace

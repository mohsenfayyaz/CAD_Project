...
#
# Generated by Vivado on Thu Jan 16 22:04:34 +0330 2020
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_CAD.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_CAD.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../project_CAD.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
